    ...
    <section className={styles.about}>
      <div className="container">
        ...
        <div className={styles.about__inner}>
          <div className={cn(styles.about__info_wrapper, darkModeClass)}>
            <div className={cn(styles.info, darkModeClass)}>
              <p>
                Компания &quot;АкваТермикс&quot; предлагает Вам запасные части
                для европейских, корейских и отечественных газовых и
                электрических котлов. 99% запчастей представленных на сайте
